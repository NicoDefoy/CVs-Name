...
adjectives = [
    ...
    "Unique", "Vibrant", "Wonderful", "Zealous", "Adventurous",
...
animals = [
    ...
    "Jellyfish", "Starfish", "Crab", "Lobster", "Seahorse", "Camel",
    "Hedgehog", "Swan", "Peacock", "Bison", "Raccoon", "Bat", "Koala", "Flamingo", "Owl", "Hawk", "Butterfly", "Bee", "Parrot", "Dog", "Cat", "Mouse"
]
